...
Section cap_lang_rules.
 ...
 (* -------------------------------- SUCCESS RULES ---------------------------------- *)
  ...
  Lemma wp_GetL_success E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc pc_a':
  ...
  Proof.
    iIntros (Hinstr Hvpc Hpca' Hne ϕ) "(HPC & Hpc_a & Hsrc & Hdst) Hϕ".
    iApply wp_lift_atomic_head_step_no_fork; auto.
    ...
    - iModIntro. iNext. iIntros (e1 σ2 efs Hstep).
      ...
      + clear H9. unfold RegLocate in H8; rewrite H1 in H8. inv H8.
        unfold MemLocate. rewrite H2. rewrite Hinstr.
        ...
        * rewrite H3. destruct wsrc.
          { simpl. iFrame. destruct (reg_eq_dec src dst).
            ...
            - iSpecialize ("Hϕ" with "[HPC Hpc_a Hsrc Hdst]"); iFrame. auto. }
          { simpl. destruct c. destruct p0. destruct p0. destruct p0.
            rewrite /update_reg /updatePC /RegLocate /= lookup_insert_ne; auto.
            rewrite H1 Hpca' /=.
            destruct (reg_eq_dec src dst).
            - subst src.
  ...
  Lemma wp_GetP_success E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc pc_a':
  ...
  Lemma wp_GetB_success E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc pc_a':
    cap_lang.decode w = GetB dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = Some pc_a' ->
    PC <> dst ->
  ...
  Lemma wp_GetE_success E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc pc_a':
    cap_lang.decode w = GetE dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = Some pc_a' ->
    PC <> dst ->
  ...
  Lemma wp_GetA_success E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc pc_a':
    cap_lang.decode w = GetA dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = Some pc_a' ->
    PC <> dst ->
  ...
  Lemma wp_store_success_local_reg E pc_p pc_g pc_b pc_e pc_a pc_a' w dst src w'
   ...
   Lemma wp_lea_success_reg_PC Ep pc_p pc_g pc_b pc_e pc_a pc_a' w r1 rv z a' :
     ...
     {{{ ▷ PC ↦ᵣ inr ((pc_p,pc_g),pc_b,pc_e,pc_a)
       ...
       {{{ RET NextIV;
           PC ↦ᵣ inr ((pc_p,pc_g),pc_b,pc_e,pc_a')
              ...
              ∗ rv ↦ᵣ inl z }}}.
   Proof.
     iIntros (Hinstr Hvpc Hpca' Ha' Hne1 Hnep ϕ) "(>HPC & >Hpc_a & >Hrv) Hϕ".
     iApply wp_lift_atomic_head_step_no_fork; auto.
     iIntros (σ1 l1 l2 n) "Hσ1 /=". destruct σ1; simpl.
     iDestruct "Hσ1" as "[Hr Hm]".
     iDestruct (@gen_heap_valid with "Hr HPC") as %?.
   ...
   Lemma wp_lea_success_z_PC Ep pc_p pc_g pc_b pc_e pc_a pc_a' w z a' :
     ...
     {{{ RET NextIV;
         PC ↦ᵣ inr ((pc_p,pc_g),pc_b,pc_e,pc_a')
            ∗ pc_a ↦ₐ w }}}.
   Proof.
     iIntros (Hinstr Hvpc Hpca' Ha' Hnep ϕ) "(>HPC & >Hpc_a) Hϕ".
     iApply wp_lift_atomic_head_step_no_fork; auto.
     iIntros (σ1 l1 l2 n) "Hσ1 /=". destruct σ1; simpl.
     iDestruct "Hσ1" as "[Hr Hm]".
     iDestruct (@gen_heap_valid with "Hr HPC") as %?.
   ...
   Lemma wp_move_success_reg_samePC E pc_p pc_g pc_b pc_e pc_a pc_a' w :
     ...
     {{{ RET NextIV;
         PC ↦ᵣ inr ((pc_p,pc_g),pc_b,pc_e,pc_a')
            ∗ pc_a ↦ₐ w }}}.
   Proof.
     iIntros (Hinstr Hvpc Hpca' ϕ) "(>HPC & >Hpc_a) Hϕ".
     iApply wp_lift_atomic_head_step_no_fork; auto.
     iIntros (σ1 l1 l2 n) "Hσ1 /=". destruct σ1; simpl.
     iDestruct "Hσ1" as "[Hr Hm]".
     iDestruct (@gen_heap_valid with "Hr HPC") as %?.
   ...
   Lemma wp_move_success_reg_toPC E pc_p pc_g pc_b pc_e pc_a w r1 p g b e a a':
    ...
    {{{ RET NextIV;
          PC ↦ᵣ inr ((p,g),b,e,a')
             ...
             ∗ r1 ↦ᵣ inr ((p,g),b,e,a) }}}.
   Proof.
     iIntros (Hinstr Hvpc Hpca' ϕ) "(>HPC & >Hpc_a & >Hr1) Hϕ".
     iApply wp_lift_atomic_head_step_no_fork; auto.
     iIntros (σ1 l1 l2 n) "Hσ1 /=". destruct σ1; simpl.
     iDestruct "Hσ1" as "[Hr Hm]".
     iDestruct (@gen_heap_valid with "Hr HPC") as %?.
 ...
 (* ----------------------------------- FAIL RULES ---------------------------------- *)
  ...
  Qed.
   ...
   Lemma wp_move_fail_z E pc_p pc_g pc_b pc_e pc_a w r1 wr1 z :
     cap_lang.decode w = Mov r1 (inl z) →
     isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
     (pc_a + 1)%a = None →
     PC ≠ r1 →
   ...
   Lemma wp_move_fail_reg E pc_p pc_g pc_b pc_e pc_a w r1 wr1 rv wrv :
     cap_lang.decode w = Mov r1 (inr rv) →
     isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
     (pc_a + 1)%a = None →
     PC ≠ r1 →
   ...
   Lemma wp_move_fail_reg_same E pc_p pc_g pc_b pc_e pc_a w r1 wr1 :
     cap_lang.decode w = Mov r1 (inr r1) →
     isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
     (pc_a + 1)%a = None →
     PC ≠ r1 →
   ...
   Lemma wp_move_fail_reg_samePC E pc_p pc_g pc_b pc_e pc_a w :
     cap_lang.decode w = Mov PC (inr PC) →
     isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
     (pc_a + 1)%a = None →
   ...
   Lemma wp_move_fail_reg_toPC E pc_p pc_g pc_b pc_e pc_a w r1 p g b e a:
    cap_lang.decode w = Mov PC (inr r1) →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (a + 1)%a = None →
   ...
   Lemma wp_move_fail_reg_toPC2 E pc_p pc_g pc_b pc_e pc_a w nr1 z:
    ...
    {{{ RET FailedV;
          PC ↦ᵣ inl z
             ...
             ∗ (match nr1 with inr r1 => r1 ↦ᵣ inl z | inl m => ⌜m = z⌝ end) }}}.
   Proof.
     iIntros (Hinstr Hvpc ϕ) "(>HPC & >Hpc_a & Hr1) Hϕ".
     iApply wp_lift_atomic_head_step_no_fork; auto.
     iIntros (σ1 l1 l2 n) "Hσ1 /=". destruct σ1; simpl.
     iDestruct "Hσ1" as "[Hr Hm]".
     iDestruct (@gen_heap_valid with "Hr HPC") as %?.
     ...
     - rewrite /reducible. destruct nr1.
       ...
       { iExists [], (Instr _),_, [].
         ...
         eapply (step_exec_instr (r,m) pc_p pc_g pc_b pc_e pc_a
                                 ...
                                 (_,_)); eauto; simpl; try congruence.
         rewrite Hpc_a. eauto.
         rewrite /updatePC /update_reg /= /RegLocate lookup_insert H3; eauto. }
     - (*iMod (fupd_intro_mask' ⊤) as "H"; eauto.*)
       iModIntro. iNext.
       iIntros (e1 σ2 efs Hstep).
       inv_head_step_advanced m r HPC Hpc_a Hinstr Hstep Hpc_new1.
       ...
       { rewrite lookup_insert /=. subst z0.
         iMod (@gen_heap_update with "Hr HPC") as "[$ HPC]".
         iSpecialize ("Hϕ" with "[HPC Hpc_a]"); iFrame; eauto. }
       { rewrite lookup_insert /= H3.
         iMod (@gen_heap_update with "Hr HPC") as "[$ HPC]".
         iSpecialize ("Hϕ" with "[HPC Hr1 Hpc_a]"); iFrame; eauto. }
   Qed.

   Lemma wp_move_fail_reg_fromPC E pc_p pc_g pc_b pc_e pc_a w r1 wr1 :
     cap_lang.decode w = Mov r1 (inr PC) →
     isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
     (pc_a + 1)%a = None →
     PC ≠ r1 →
  ...
  Lemma wp_GetL_failPC E src pc_p pc_g pc_b pc_e pc_a w wsrc:
    ...
    {{{ RET FailedV;
        PC ↦ᵣ (if reg_eq_dec PC src then inl (encodeLoc pc_g) else match wsrc with inr ((_,g'),_,_,_) => inl (encodeLoc g') | inl _ => inr ((pc_p,pc_g),pc_b,pc_e,pc_a) end)
           ...
           ∗ (if reg_eq_dec PC src then emp else src ↦ᵣ wsrc) }}}.
  Proof.
    iIntros (Hinstr Hvpc ϕ) "(HPC & Hpc_a & Hsrc) Hϕ".
    iApply wp_lift_atomic_head_step_no_fork; auto.
    iIntros (σ1 l1 l2 n) "Hσ1". destruct σ1.
    iDestruct "Hσ1" as "[Hr Hm]".
    iDestruct (@gen_heap_valid with "Hr HPC") as %?.
...
Lemma wp_GetL_fail E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc:
    cap_lang.decode w = GetL dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = None ->
    PC <> dst ->
  ...
  Lemma wp_GetP_failPC E src pc_p pc_g pc_b pc_e pc_a w wsrc:
  ...
  Lemma wp_GetP_fail E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc:
    cap_lang.decode w = GetP dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = None ->
    PC <> dst ->
  ...
  Lemma wp_GetB_failPC E src pc_p pc_g pc_b pc_e pc_a w wsrc:
  ...
  Lemma wp_GetB_fail E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc:
    cap_lang.decode w = GetB dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = None ->
    PC <> dst ->
  ...
  Lemma wp_GetE_failPC E src pc_p pc_g pc_b pc_e pc_a w wsrc:
  ...
  Lemma wp_GetE_fail E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc:
    cap_lang.decode w = GetE dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = None ->
    PC <> dst ->
  ...
  Lemma wp_GetA_failPC E src pc_p pc_g pc_b pc_e pc_a w wsrc:
  ...
  Lemma wp_GetA_fail E dst src pc_p pc_g pc_b pc_e pc_a w wdst wsrc:
    cap_lang.decode w = GetA dst src →
    isCorrectPC (inr ((pc_p,pc_g),pc_b,pc_e,pc_a)) →
    (pc_a + 1)%a = None ->
    PC <> dst ->
  ...
  Qed.
   ...
   Lemma wp_lea_failPC1 Ep pc_p pc_g pc_b pc_e pc_a w n:
   ...
   Lemma wp_lea_failPCreg1 Ep pc_p pc_g pc_b pc_e pc_a w n r1:
   ...
   Lemma wp_lea_failPC1' Ep pc_p pc_g pc_b pc_e pc_a w n a':
     cap_lang.decode w = Lea PC (inl n) →
   ...
   Lemma wp_lea_failPCreg1' Ep pc_p pc_g pc_b pc_e pc_a w n a' r1:
     cap_lang.decode w = Lea PC (inr r1) →
   ...
   Lemma wp_lea_fail1' Ep dst pc_p pc_g pc_b pc_e pc_a w p g b e a n a':
     cap_lang.decode w = Lea dst (inl n) →
     ...
     {{{ PC ↦ᵣ inr ((pc_p,pc_g),pc_b,pc_e,pc_a)
       ...
       {{{ RET FailedV; True }}}.
   Proof.
     intros Hinstr Hvpc Hp Ha Ha' Hnepc;
     (iIntros (φ) "(HPC & Hpc_a & Hdst) Hφ";
      iApply wp_lift_atomic_head_step_no_fork; auto;
      iIntros (σ1 l1 l2 n') "Hσ1 /="; destruct σ1; simpl;
      iDestruct "Hσ1" as "[Hr Hm]";
   ...
   Lemma wp_lea_fail4' Ep dst pc_p pc_g pc_b pc_e pc_a w p g b e a rg n a':
     cap_lang.decode w = Lea dst (inr rg) →
     ...
     {{{ PC ↦ᵣ inr ((pc_p,pc_g),pc_b,pc_e,pc_a)
       ...
       {{{ RET FailedV; True }}}.
   Proof.
     intros Hinstr Hvpc Hp Ha Ha' Hne;
     (iIntros (φ) "(HPC & Hpc_a & Hdst & Hrg) Hφ";
      iApply wp_lift_atomic_head_step_no_fork; auto;
      iIntros (σ1 l1 l2 n') "Hσ1 /="; destruct σ1; simpl;
      iDestruct "Hσ1" as "[Hr Hm]";
   ...
   Lemma wp_lea_failPC5 Ep pc_p pc_g pc_b pc_e pc_a w rg x:
   ...
   Lemma wp_lea_fail6 Ep dst pc_p pc_g pc_b pc_e pc_a w:
   ...
   Lemma wp_lea_fail7 Ep dst pc_p pc_g pc_b pc_e pc_a w x:
