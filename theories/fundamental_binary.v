...
From cap_machine.ftlr_binary Require Export Mov_binary Load_binary AddSubLt_binary Get_binary GetWType_binary Jmp_binary Jnz_binary Lea_binary Subseg_binary Restrict_binary Store_binary Seal_binary UnSeal_binary.
...
Section fundamental.
  ...
  Proof.
    ...
    - assert ((b <= a)%a ∧ (a < e)%a) as Hbae.
      ...
      + (* GetWType *) iApply (getwtype_case with "[] [] [] [] [] [] [Hsreg] [Hown] [Hs] [Ha] [Ha'] [HP] [Hcls] [HPC] [Hmap]"); try iAssumption; eauto.
