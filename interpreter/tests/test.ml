...
let test_enc_dec_stm_list = [
  ...
  (Add (Reg 5, Register (Reg 6), CP (Const 8128)), "encode-decode Add R5 R6 8128");
  (Add (Reg 5, Register (Reg 6), CP (Perm (RO, Global))), "encode-decode Add R5 R6 RO");
  (Add (Reg 5, CP (Const (-549)), Register PC), "encode-decode Add R5 (-549) PC");
  (Add (Reg 5, CP (Const (102)), CP (Const 8128)), "encode-decode Add R5 102 8128");
  (Add (Reg 5, CP (Const (83)), CP (Perm (RO, Global))), "encode-decode Add R5 83 RO");
  (Add (Reg 5, CP (Perm (E, Global)), Register PC), "encode-decode Add R5 E PC");
  (Add (Reg 5, CP (Perm (O, Global)), CP (Const 8128)), "encode-decode Add R5 O 8128");
  ...
  (Sub (Reg 5, Register (Reg 6), CP (Const 8128)), "encode-decode Sub R5 R6 8128");
  (Sub (Reg 5, Register (Reg 6), CP (Perm (RO, Global))), "encode-decode Sub R5 R6 RO");
  (Sub (Reg 5, CP (Const (-549)), Register PC), "encode-decode Sub R5 (-549) PC");
  (Sub (Reg 5, CP (Const (102)), CP (Const 8128)), "encode-decode Sub R5 102 8128");
  (Sub (Reg 5, CP (Const (83)), CP (Perm (RO, Global))), "encode-decode Sub R5 83 RO");
  (Sub (Reg 5, CP (Perm (E, Global)), Register PC), "encode-decode Sub R5 E PC");
  (Sub (Reg 5, CP (Perm (O, Global)), CP (Const 8128)), "encode-decode Sub R5 O 8128");
  ...
  (Lt (Reg 5, Register (Reg 6), CP (Const 8128)), "encode-decode Lt R5 R6 8128");
  (Lt (Reg 5, Register (Reg 6), CP (Perm (RO, Global))), "encode-decode Lt R5 R6 RO");
  (Lt (Reg 5, CP (Const (-549)), Register PC), "encode-decode Lt R5 (-549) PC");
  (Lt (Reg 5, CP (Const (102)), CP (Const 8128)), "encode-decode Lt R5 102 8128");
  (Lt (Reg 5, CP (Const (83)), CP (Perm (RO, Global))), "encode-decode Lt R5 83 RO");
  (Lt (Reg 5, CP (Perm (E, Global)), Register PC), "encode-decode Lt R5 E PC");
  (Lt (Reg 5, CP (Perm (O, Global)), CP (Const 8128)), "encode-decode Lt R5 O 8128");
  (Lt (Reg 5, CP (Perm (RWX, Global)), CP (Perm (RO, Global))), "encode-decode Lt R5 RWX RO");
  (Lea (PC, Register (Reg 7)), "encode-decode Lea PC R7");
  (Lea (PC, CP (Const (-35))), "encode-decode Lea PC (-35)");
  (Lea (PC, CP (Perm (E, Global))), "encode-decode Lea PC E");
  (Restrict (PC, Register (Reg 7)), "encode-decode Restrict PC R7");
  (Restrict (PC, CP (Const (-35))), "encode-decode Restrict PC (-35)");
  ...
  (SubSeg (Reg 5, CP (Const (-549)), Register PC), "encode-decode SubSeg R5 (-549) PC");
  (SubSeg (Reg 5, CP (Const (102)), CP (Const 8128)), "encode-decode SubSeg R5 102 8128");
  (SubSeg (Reg 5, CP (Const (83)), CP (Perm (RO, Local))), "encode-decode SubSeg R5 83 RO Local");
  (SubSeg (Reg 5, CP (Perm (E, Global)), Register PC), "encode-decode SubSeg R5 E PC");
  (SubSeg (Reg 5, CP (Perm (O, Global)), CP (Const 8128)), "encode-decode SubSeg R5 O 8128");
