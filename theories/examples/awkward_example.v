...
Section awkward_example.
  ...
  Lemma f4_spec W pc_p pc_g pc_b pc_e (* PC *)
    ...
    {{{ r_stk ↦ᵣ inr ((RWLX,Local),b_r,e_r,b_r')
      ...
      (* stack *)
      ∗ ([∗ list] a ∈ (region_addrs b_r e_r), rel a RWLX (λ Wv : WORLD * Word, (interp Wv.1) Wv.2))
      (* token which states all non atomic invariants are closed *)
      ∗ na_own logrel_nais ⊤
      (* adv code *)
      ∗ ([∗ list] a ∈ (region_addrs b e), (read_write_cond a RX interp) ∧ ⌜region_state_nwl W a Global⌝)
      (* callback validity *)
  ...
  Proof.
    ...
    { rewrite !dom_insert_L Hrmap_dom !singleton_union_difference_L !all_registers_union_l.
      f_equal. clear. set_solver. }
    ...
    { iApply (registers_mapsto_resources with "Hr_gen Hr_stk Hr_t0 Hr_adv HPC").
      rewrite !dom_delete_L dom_insert_L dom_insert_L Hrmap_dom.
    ...
    { iIntros (r1).
      ...
      - assert (r !! r_stk = Some (inr (RWLX, Local, stack_own_last, e_r, stack_own_end))) as Hr_stk; auto. 
        ...
        { rewrite Hstack_eq. 
          ...
          + revert Hrevoked. rewrite Forall_forall =>Hrevoked.
            ...
            rewrite std_sta_update_multiple_lookup_same_i /std /=. rewrite HeqW' in Hrevoked. 
      ...
      - (* continuation *)
        ...
        iAssert (∃ ws_own : list Word, [[a4,stack_own_end]]↦ₐ[RWLX][[ws_own]])%I with "[Hframe Ha4]" as (ws_own'') "Hstack_own".
