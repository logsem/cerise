...
Section cap_lang_rules.
    ...
    destruct (is_mutable_range wdst) eqn:Hwdst.
     2: { (* Failure: wdst is not of the right type *)
       ...
       { destruct wdst as [ | [p b e a | ] | ]; try by inversion Hwdst.
         ...
         all: repeat destruct (addr_of_argument r _); cbn in Hstep; simplify_pair_eq; auto. }
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hdst & >Hr1 & >Hr2) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hdst & >Hr1) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hdst & >Hr2) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hdst & >Hr1) Hφ".
    iDestruct (map_of_regs_3 with "HPC Hr1 Hdst") as "[Hmap (%&%&%)]".
    iApply (wp_Subseg with "[$Hmap Hpc_a]"); eauto; simplify_map_eq; eauto.
    by unfold regs_of; rewrite !dom_insert; set_solver+.
    iNext. iIntros (regs' retv) "(#Hspec & Hpc_a & Hmap)". iDestruct "Hspec" as %Hspec.
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hdst) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hr1 & >Hr2) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hr1) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hr2) Hφ".
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a & >Hr1) Hφ".
    iDestruct (map_of_regs_2 with "HPC Hr1") as "[Hmap %]".
    iApply (wp_Subseg with "[$Hmap Hpc_a]"); eauto; simplify_map_eq; eauto.
    by unfold regs_of; rewrite !dom_insert; set_solver+.
    iNext. iIntros (regs' retv) "(#Hspec & Hpc_a & Hmap)". iDestruct "Hspec" as %Hspec.
  ...
  Proof.
    iIntros (Hinstr Hvpc Hn1 Hn2 Hpne Hpniepair Hpniepcc Hwb Hpc_a' ϕ) "(>HPC & >Hpc_a) Hφ".
