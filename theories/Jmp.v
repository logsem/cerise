...
Section fundamental.
  ...
  Lemma RWX_Jmp_case:
    ∀ (E0 : coPset) (r : leibnizC Reg) (a : Addr) (g : Locality) (fs : leibnizC STS_states) (fr : leibnizC STS_rels) 
      (b e : Addr) (ws : list Word) (w : Word) (r0 : RegName)
      (fundamental_RX : ∀ (stsf : prodC (leibnizC STS_states) (leibnizC STS_rels)) (E : coPset) (r : leibnizC Reg) 
                          (b e : Addr) (g : Locality) (a : Addr) (ws : list Word), (na_inv logrel_nais 
                                                                                           (logN.@(b, e))
                                                                                           (read_only_cond b e ws interp)
                                                                                    → (λ (stsf0 : prodC 
                                                                                                    (leibnizC STS_states)
                                                                                                    (leibnizC STS_rels)) 
                                                                                         (E0 : coPset) 
