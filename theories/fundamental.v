...
Section fundamental.
  ...
  Lemma fundamental_RX stsf E r b e g (a : Addr) :
    ((∃ p, ⌜PermFlows RX p⌝ ∧
  ...
  { clear fundamental_RX.
    ...
    - (* Correct PC *)
      ...
      + (* Load *)
        iApply (RX_Load_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Store *)
        iApply (RX_Store_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Lt *)
        iApply (RX_Add_Sub_Lt_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Add *)
        iApply (RX_Add_Sub_Lt_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Sub *)
        iApply (RX_Add_Sub_Lt_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* Lea *)
        iApply (RX_Lea_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* Restrict *)
        iApply (RX_Restrict_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Subseg *)
        iApply (RX_Subseg_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* IsPtr *) 
        iApply (RX_IsPtr_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* GetL *)
        iApply (RX_getL_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.  
      + (* GetP *)
        iApply (RX_getP_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* GetB *)
        iApply (RX_getB_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.  
      + (* GetE *)
        iApply (RX_getE_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* GetA *)
        iApply (RX_getA_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Fail *)
...
(* ======= *)
      ...
      destruct (cap_lang.decode w) eqn:Hi. (* proof by cases on each instruction *)
      + (* Jmp *)
        iApply (RWX_jmp_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Jnz *) admit.
      + (* Mov *) admit.
      + (* Load *) admit.
      + (* Store *) admit.
      + (* Lt *)
        iApply (RWX_Add_Sub_Lt_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Add *)
        iApply (RWX_Add_Sub_Lt_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto. 
      + (* Sub *)
        iApply (RWX_Add_Sub_Lt_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.  
      ...
      + (* IsPtr *) admit. 
      + (* GetL *) 
        iApply (RWX_getL_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* GetP *)
        iApply (RWX_getP_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* GetB *)
        iApply (RWX_getB_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* GetE *)
        iApply (RWX_getE_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* GetA *)
        iApply (RWX_getA_case with "[] [] [] [] [] [] [Hsts] [Ha] [Hown] [Hcls] [HPC] [Hmap]"); eauto.
      + (* Fail *) 
        iApply (wp_fail with "[HPC Ha]"); eauto; iFrame.
        iNext. iIntros "[HPC Ha] /=".
        iApply wp_pure_step_later; auto.
