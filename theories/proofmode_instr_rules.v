...
Ltac dispatch_instr_rule instr cont :=
  ...
  | Subseg _ (inr ?r) (inr ?r) => cont (@wp_subseg_success_same)
  | Subseg _ (inr _) (inr _) => cont (@wp_subseg_success)
  | Subseg _ (inl _) (inr _) => cont (@wp_subseg_success_l)
  | Subseg _ (inr _) (inl _) => cont (@wp_subseg_success_r)
  | Subseg _ (inl _) (inl _) => cont (@wp_subseg_success_lr)
  (* IsPtr *)
  | IsPtr _ PC => cont (@wp_IsPtr_successPC)
  | IsPtr ?r ?r => cont (@wp_IsPtr_success_dst)
  | IsPtr _ _ => cont (@wp_IsPtr_success)
  (* Restrict *)
