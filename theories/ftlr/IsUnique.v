...
Section fundamental.
  ...
  Lemma mem_map_recover_res_update_version
    (glmem lmem lmem': LMem) (lregs : LReg) (src : RegName)
    ...
    length la = length Ps ->
    p_src ≠ machine_base.E ->
    is_valid_updated_lmemory glmem lmem (finz.seq_between b_src e_src) v_src lmem' ->
  ...
  Proof.
    ...
    destruct Hspec as
      [ p_src' b_src' e_src' glmem a_src' v_src' Hlwsrc' Hp_neq_E Hupd Hnotres Hunique_regs Hincr_PC
